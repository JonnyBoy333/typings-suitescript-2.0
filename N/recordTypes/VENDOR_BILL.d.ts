...
// expense field types
type expense_select = 'account' | 'amortizationsched' | 'category' | 'class' | 'customer' | 'department' | 'location';
type expense_date = 'amortizationenddate' | 'amortizstartdate';
type expense_rate = 'amortizationresidual';
type expense_text = 'amortizationtype' | 'line' | 'memo' | 'orderdoc' | 'orderline' | 'scheduletype';
type expense_currency = 'amount' | 'grossamt';
...
type item_select = 'amortizationsched' | 'billreceipts' | 'catchupperiod' | 'class' | 'customer' | 'department' | 'item' | 'landedcostcategory' | 'location' | 'units';
type item_text = 'amortizationtype' | 'billvariancestatus' | 'id' | 'isvsoebundle' | 'itemsubtype' | 'itemtype' | 'line' | 'matrixtype' | 'orderdoc' | 'orderline' | 'rateschedule' | 'scheduletype' | 'vendorname';
type item_currency = 'amount' | 'grossamt';
...
export interface RecordCreateOptions_VENDOR_BILL { // This one gets exported
    /**
     * The record type.
     */
...
export interface RecordTransformOptions_VENDOR_BILL { // This one gets exported
...
export interface CopyLoadOptions_VENDOR_BILL { // This one gets exported
    /**
     * The record type.
     */
    type: Type.VENDOR_BILL;
...
export interface VENDOR_BILL extends Record {
