...
type item_select = 'catchupperiod' | 'costestimatetype' | 'item' | 'job' | 'price' | 'revrecschedule' | 'taxcode' | 'units' | 'vsoedeferral' | 'vsoepermitdiscount' | 'vsoesopgroup';
type item_rate = 'costestimaterate' | 'rate';
type item_checkbox = 'deferrevrec' | 'isclosed' | 'isdropshipment' | 'istaxable' | 'vsoedelivered' | 'vsoeisestimate';
...
type item_float = 'quantity' | 'quantitybilled' | 'quantityreceived' | 'quantityrevcommitted';
...
interface FindSublistLineWithValueOptions_item {
    ...
    sublistId: 'item';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: item_currency | item_text | item_select | item_rate | item_checkbox | item_textarea | item_email | item_summary | item_integer | item_namevaluelist | item_float | item_date | item_percent | item_currency2;
    /** The value to search for. */
    value: FieldValue;
}
...
export interface RecordCreateOptions_RETURN_AUTHORIZATION { // This one gets exported
    /**
     * The record type.
     */
    type: Type.RETURN_AUTHORIZATION;
    /**
...
export interface RecordTransformOptions_RETURN_AUTHORIZATION { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.RETURN_AUTHORIZATION;
...
export interface CopyLoadOptions_RETURN_AUTHORIZATION { // This one gets exported
    /**
     * The record type.
     */
    type: Type.RETURN_AUTHORIZATION;
...
export interface RETURN_AUTHORIZATION extends Record {
