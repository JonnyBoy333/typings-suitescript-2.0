...
type escalateto_select = 'escalatee';
type escalateto_phone = 'phone';

// timeitem field types
type timeitem_select = 'class' | 'department' | 'employee' | 'item' | 'location' | 'payrollitem' | 'timetype';
type timeitem_timetrack = 'hours';
type timeitem_integer = 'id';
type timeitem_checkbox = 'isbillable';
...
// escalateto type definitions
interface FindSublistLineWithValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface GetMatrixHeaderCountOptions_escalateto {
...
interface GetMatrixHeaderFieldOptions_escalateto {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'escalateto';
...
interface GetMatrixSublistFieldOptions_escalateto {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'escalateto';
    /** The intenral ID of the matrix field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface GetSublistValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface SetCurrentMatrixSublistValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface SetCurrentSublistValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface SetCurrentSublistTextOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface SetSublistTextOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface SetSublistValueOptions_escalateto {
    /** The internal ID of the sublist. */
    sublistId: 'escalateto';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: escalateto_email | escalateto_select | escalateto_phone;
...
interface FindSublistLineWithValueOptions_timeitem {
    ...
    sublistId: 'timeitem';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: timeitem_select | timeitem_timetrack | timeitem_integer | timeitem_checkbox | timeitem_text | timeitem_textarea | timeitem_date;
    /** The value to search for. */
    value: FieldValue;
}
...
export interface RecordCreateOptions_SUPPORT_CASE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.SUPPORT_CASE;
    /**
...
export interface RecordTransformOptions_SUPPORT_CASE { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.SUPPORT_CASE;
...
export interface CopyLoadOptions_SUPPORT_CASE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.SUPPORT_CASE;
...
export interface SUPPORT_CASE extends Record {
    ...
    getSublistField(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): Field;
    /** Returns the value of a sublist field in a text representation. */
    getSublistText(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): string;
    /** Returns a value indicating whether the associated sublist field contains a subrecord. */
    hasSublistSubrecord(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): boolean;
    /** Gets the subrecord associated with a sublist field. */
    getSublistSubrecord(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): Record;
    /** Removes the subrecord for the associated sublist field. */
    removeSublistSubrecord(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): Record;
    /** Returns the line number of the currently selected line. */
    getCurrentSublistIndex(options: GetSublistValueOptions_escalateto | GetSublistValueOptions_timeitem): number;
