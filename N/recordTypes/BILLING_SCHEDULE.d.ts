...
type main_select = 'frequency' | 'initialterms' | 'project' | 'recurrencepattern' | 'recurrenceterms' | 'repeatevery' | 'scheduletype' | 'transaction';
type main_ratehighprecision = 'initialamount';
type main_integer = 'numberremaining';
type main_date = 'seriesstartdate';

// milestone field types
type milestone_text = 'comments';
type milestone_date = 'milestoneactualcompletiondate' | 'milestonedate';
type milestone_percent = 'milestoneamount';
type milestone_checkbox = 'milestonecompleted';
type milestone_select = 'milestoneterms' | 'projecttask';

// recurrence field types
type recurrence_ratehighprecision = 'amount';
type recurrence_integer = 'count';
type recurrence_select = 'paymentterms' | 'units';
type recurrence_date = 'recurrencedate';
type recurrence_checkbox = 'relativetoprevious';
...
interface CancelCommitLineOptions {
    ...
    sublistId: 'milestone' | 'recurrence';
}
...
interface FindSublistLineWithValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface GetMatrixHeaderCountOptions_milestone {
...
interface GetMatrixHeaderFieldOptions_milestone {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'milestone';
...
interface GetMatrixSublistFieldOptions_milestone {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'milestone';
    /** The intenral ID of the matrix field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface GetSublistValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface SetCurrentMatrixSublistValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface SetCurrentSublistValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface SetCurrentSublistTextOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface SetSublistTextOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface SetSublistValueOptions_milestone {
    /** The internal ID of the sublist. */
    sublistId: 'milestone';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: milestone_text | milestone_date | milestone_percent | milestone_checkbox | milestone_select;
...
interface FindSublistLineWithValueOptions_recurrence {
    ...
    /** The internal ID of a standard or custom sublist field. */
    fieldId: recurrence_ratehighprecision | recurrence_integer | recurrence_select | recurrence_date | recurrence_checkbox;
    /** The value to search for. */
    value: FieldValue;
}
...
interface HasSubrecordOptions {
    ...
    fieldId: main_checkbox | main_text | main_select | main_ratehighprecision | main_integer | main_date;
}
...
export interface RecordCreateOptions_BILLING_SCHEDULE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BILLING_SCHEDULE;
    /**
...
export interface RecordTransformOptions_BILLING_SCHEDULE { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.BILLING_SCHEDULE;
...
export interface CopyLoadOptions_BILLING_SCHEDULE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BILLING_SCHEDULE;
...
export interface BILLING_SCHEDULE extends Record {
    ...
    getSublistField(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): Field;
    /** Returns the value of a sublist field in a text representation. */
    getSublistText(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): string;
    /** Returns a value indicating whether the associated sublist field contains a subrecord. */
    hasSublistSubrecord(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): boolean;
    /** Gets the subrecord associated with a sublist field. */
    getSublistSubrecord(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): Record;
    /** Removes the subrecord for the associated sublist field. */
    removeSublistSubrecord(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): Record;
    /** Returns the line number of the currently selected line. */
    getCurrentSublistIndex(options: GetSublistValueOptions_milestone | GetSublistValueOptions_recurrence): number;
