...
export interface RecordCreateOptions_NOTE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.NOTE;
...
export interface RecordTransformOptions_NOTE { // This one gets exported
...
export interface CopyLoadOptions_NOTE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.NOTE;
