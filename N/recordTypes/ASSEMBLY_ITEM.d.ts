...
type member_integer = 'linenumber';
...
interface FindSublistLineWithValueOptions_member {
    ...
    sublistId: 'member';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: member_date | member_select | member_integer | member_textarea | member_text | member_posfloat;
    /** The value to search for. */
    value: FieldValue;
}
...
export interface RecordCreateOptions_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ASSEMBLY_ITEM;
    /**
...
export interface RecordTransformOptions_ASSEMBLY_ITEM { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.ASSEMBLY_ITEM;
...
export interface CopyLoadOptions_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ASSEMBLY_ITEM;
...
export interface ASSEMBLY_ITEM extends Record {
