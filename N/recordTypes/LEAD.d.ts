...
type main_checkbox = 'autoname' | 'emailtransactions' | 'faxtransactions' | 'giveaccess' | 'isbudgetapproved' | 'isinactive' | 'printtransactions' | 'sendemail' | 'syncpartnerteams' | 'syncsalesteams' | 'taxable' | 'taxexempt';
type main_currency = 'balance' | 'consolbalance' | 'consoldepositbalance' | 'consoloverduebalance' | 'consolunbilledorders' | 'depositbalance' | 'estimatedbudget' | 'overduebalance' | 'unbilledorders';
type main_textarea = 'comments';
type main_integer = 'consoldaysoverdue' | 'daysoverdue' | 'salesrep' | 'visits';
...
interface HasSubrecordOptions {
    ...
    fieldId: main_select | main_text | main_email | main_phone | main_checkbox | main_currency | main_textarea | main_integer | main_poscurrency | main_datetime | main_address | main_radio | main_url;
}
...
export interface RecordCreateOptions_LEAD { // This one gets exported
    /**
     * The record type.
     */
    type: Type.LEAD;
...
export interface RecordTransformOptions_LEAD { // This one gets exported
...
export interface CopyLoadOptions_LEAD { // This one gets exported
    /**
     * The record type.
     */
    type: Type.LEAD;
