...
// item field types
type item_text = 'billvariancestatus' | 'daysbeforeexpiration' | 'id' | 'isclosed' | 'isvsoebundle' | 'itemid' | 'itemsubtype' | 'itemtype' | 'line' | 'matrixtype' | 'povendor' | 'printitems' | 'rateschedule';
type item_select = 'catchupperiod' | 'commitinventory' | 'createpo' | 'item' | 'itemsource' | 'units';
type item_checkbox = 'createwo' | 'deferrevrec';
type item_textarea = 'description';
type item_summary = 'inventorydetail';
type item_integer = 'linenumber' | 'operationsequencenumber';
type item_namevaluelist = 'options';
type item_float = 'orderpriority' | 'quantity' | 'quantityavailable' | 'quantitybackordered' | 'quantitycommitted' | 'quantityfulfilled';
type item_datetime = 'plannedissuedate';
...
interface FindSublistLineWithValueOptions_item {
    ...
    sublistId: 'item';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: item_text | item_select | item_checkbox | item_textarea | item_summary | item_integer | item_namevaluelist | item_float | item_datetime | item_currency2 | item_rate;
    /** The value to search for. */
    value: FieldValue;
}
...
export interface RecordCreateOptions_WORK_ORDER { // This one gets exported
    /**
     * The record type.
     */
...
export interface RecordTransformOptions_WORK_ORDER { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.WORK_ORDER;
...
export interface CopyLoadOptions_WORK_ORDER { // This one gets exported
    /**
     * The record type.
     */
    type: Type.WORK_ORDER;
...
export interface WORK_ORDER extends Record {
