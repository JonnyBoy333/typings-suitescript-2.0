...
type item_select = 'catchupperiod' | 'chargetype' | 'costestimatetype' | 'item' | 'job' | 'price' | 'revrecschedule' | 'shipaddress' | 'shipcarrier' | 'shipmethod' | 'subscriptionline' | 'taxcode' | 'units' | 'vsoedeferral' | 'vsoepermitdiscount' | 'vsoesopgroup';
...
export interface RecordCreateOptions_CASH_SALE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CASH_SALE;
...
export interface RecordTransformOptions_CASH_SALE { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.CASH_SALE;
...
export interface CopyLoadOptions_CASH_SALE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CASH_SALE;
...
export interface CASH_SALE extends Record {
