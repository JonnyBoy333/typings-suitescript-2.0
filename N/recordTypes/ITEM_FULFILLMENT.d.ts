...
type item_checkbox = 'excludefromraterequest' | 'itemreceive';
...
interface FindSublistLineWithValueOptions_item {
    ...
    fieldId: item_text | item_checkbox | item_summary | item_select | item_float | item_namevaluelist | item_posfloat;
...
export interface RecordCreateOptions_ITEM_FULFILLMENT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ITEM_FULFILLMENT;
    /**
...
export interface RecordTransformOptions_ITEM_FULFILLMENT { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.ITEM_FULFILLMENT;
...
export interface CopyLoadOptions_ITEM_FULFILLMENT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ITEM_FULFILLMENT;
...
export interface ITEM_FULFILLMENT extends Record {
