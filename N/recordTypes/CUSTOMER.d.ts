...
type addressbook_select = 'country' | 'dropdownstate';
...
type contactroles_password = 'passwordconfirm';
type contactroles_text = 'strength';

// creditcards field types
type creditcards_select = 'cardstate' | 'paymentmethod';
type creditcards_checkbox = 'ccdefault';
type creditcards_mmyydate = 'ccexpiredate';
type creditcards_text = 'ccmemo' | 'ccname' | 'customercode' | 'debitcardissueno';
type creditcards_ccnumber = 'ccnumber';
type creditcards_integer = 'internalid';
type creditcards_datetime = 'statefrom';
type creditcards_ccvalidfrom = 'validfrom';
...
// subscriptions field types
type subscriptions_datetime = 'lastmodifieddate';
type subscriptions_checkbox = 'subscribed';
type subscriptions_select = 'subscription';
...
interface CancelCommitLineOptions {
    ...
    sublistId: 'addressbook' | 'contactroles' | 'creditcards' | 'currency' | 'download' | 'grouppricing' | 'itempricing' | 'partners' | 'salesteam' | 'subscriptions';
}
...
// creditcards type definitions
interface FindSublistLineWithValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface GetMatrixHeaderCountOptions_creditcards {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'creditcards';
    /** The intenral ID of the matrix field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface GetMatrixHeaderFieldOptions_creditcards {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'creditcards';
    /** The internal ID of the matrix field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface GetMatrixSublistFieldOptions_creditcards {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'creditcards';
    /** The intenral ID of the matrix field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface GetSublistValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface SetCurrentMatrixSublistValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface SetCurrentSublistValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface SetCurrentSublistTextOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface SetSublistTextOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface SetSublistValueOptions_creditcards {
    /** The internal ID of the sublist. */
    sublistId: 'creditcards';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: creditcards_select | creditcards_checkbox | creditcards_mmyydate | creditcards_text | creditcards_ccnumber | creditcards_integer | creditcards_datetime | creditcards_ccvalidfrom;
...
interface FindSublistLineWithValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface GetMatrixHeaderCountOptions_subscriptions {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'subscriptions';
    /** The intenral ID of the matrix field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface GetMatrixHeaderFieldOptions_subscriptions {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'subscriptions';
    /** The internal ID of the matrix field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface GetMatrixSublistFieldOptions_subscriptions {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'subscriptions';
    /** The intenral ID of the matrix field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface GetSublistValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface SetCurrentMatrixSublistValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface SetCurrentSublistValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface SetCurrentSublistTextOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface SetSublistTextOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
interface SetSublistValueOptions_subscriptions {
    /** The internal ID of the sublist. */
    sublistId: 'subscriptions';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: subscriptions_datetime | subscriptions_checkbox | subscriptions_select;
...
export interface RecordCreateOptions_CUSTOMER { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CUSTOMER;
...
export interface RecordTransformOptions_CUSTOMER { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.CUSTOMER;
...
export interface CopyLoadOptions_CUSTOMER { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CUSTOMER;
...
export interface CUSTOMER extends Record {
    ...
    getCurrentMatrixSublistValue(options: GetCurrentSublistValueOptions_addressbook | GetCurrentSublistValueOptions_contactroles | GetCurrentSublistValueOptions_creditcards | GetCurrentSublistValueOptions_currency | GetCurrentSublistValueOptions_download | GetCurrentSublistValueOptions_grouppricing | GetCurrentSublistValueOptions_itempricing | GetCurrentSublistValueOptions_partners | GetCurrentSublistValueOptions_salesteam | GetCurrentSublistValueOptions_subscriptions): number | Date | string | string[] | boolean;
    /** Returns a value indicating whether the associated sublist field has a subrecord on the current line. This method can only be used on dynamic records. */
    hasCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_addressbook | GetCurrentSublistValueOptions_contactroles | GetCurrentSublistValueOptions_creditcards | GetCurrentSublistValueOptions_currency | GetCurrentSublistValueOptions_download | GetCurrentSublistValueOptions_grouppricing | GetCurrentSublistValueOptions_itempricing | GetCurrentSublistValueOptions_partners | GetCurrentSublistValueOptions_salesteam | GetCurrentSublistValueOptions_subscriptions): boolean;
    /** Gets the subrecord for the associated sublist field on the current line. */
    getCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_addressbook | GetCurrentSublistValueOptions_contactroles | GetCurrentSublistValueOptions_creditcards | GetCurrentSublistValueOptions_currency | GetCurrentSublistValueOptions_download | GetCurrentSublistValueOptions_grouppricing | GetCurrentSublistValueOptions_itempricing | GetCurrentSublistValueOptions_partners | GetCurrentSublistValueOptions_salesteam | GetCurrentSublistValueOptions_subscriptions): Record;
    /** Returns a text representation of the field value in the currently selected line. */
    getCurrentSublistText(options: GetCurrentSublistValueOptions_addressbook | GetCurrentSublistValueOptions_contactroles | GetCurrentSublistValueOptions_creditcards | GetCurrentSublistValueOptions_currency | GetCurrentSublistValueOptions_download | GetCurrentSublistValueOptions_grouppricing | GetCurrentSublistValueOptions_itempricing | GetCurrentSublistValueOptions_partners | GetCurrentSublistValueOptions_salesteam | GetCurrentSublistValueOptions_subscriptions): string;
    /** Returns the value of a sublist field on the currently selected sublist line. */
    getCurrentSublistValue(options: GetCurrentSublistValueOptions_addressbook | GetCurrentSublistValueOptions_contactroles | GetCurrentSublistValueOptions_creditcards | GetCurrentSublistValueOptions_currency | GetCurrentSublistValueOptions_download | GetCurrentSublistValueOptions_grouppricing | GetCurrentSublistValueOptions_itempricing | GetCurrentSublistValueOptions_partners | GetCurrentSublistValueOptions_salesteam | GetCurrentSublistValueOptions_subscriptions): FieldValue;
    /** Returns the number of columns for the specified matrix. */
    getMatrixHeaderCount(options: GetMatrixHeaderCountOptions_addressbook | GetMatrixHeaderCountOptions_contactroles | GetMatrixHeaderCountOptions_creditcards | GetMatrixHeaderCountOptions_currency | GetMatrixHeaderCountOptions_download | GetMatrixHeaderCountOptions_grouppricing | GetMatrixHeaderCountOptions_itempricing | GetMatrixHeaderCountOptions_partners | GetMatrixHeaderCountOptions_salesteam | GetMatrixHeaderCountOptions_subscriptions): number;
    /** Gets the field for the specified header in the matrix. */
    getMatrixHeaderField(options: GetMatrixHeaderFieldOptions_addressbook | GetMatrixHeaderFieldOptions_contactroles | GetMatrixHeaderFieldOptions_creditcards | GetMatrixHeaderFieldOptions_currency | GetMatrixHeaderFieldOptions_download | GetMatrixHeaderFieldOptions_grouppricing | GetMatrixHeaderFieldOptions_itempricing | GetMatrixHeaderFieldOptions_partners | GetMatrixHeaderFieldOptions_salesteam | GetMatrixHeaderFieldOptions_subscriptions): Field;
    /** Gets the value for the associated header in the matrix. */
    getMatrixHeaderValue(options: GetMatrixHeaderFieldOptions_addressbook | GetMatrixHeaderFieldOptions_contactroles | GetMatrixHeaderFieldOptions_creditcards | GetMatrixHeaderFieldOptions_currency | GetMatrixHeaderFieldOptions_download | GetMatrixHeaderFieldOptions_grouppricing | GetMatrixHeaderFieldOptions_itempricing | GetMatrixHeaderFieldOptions_partners | GetMatrixHeaderFieldOptions_salesteam | GetMatrixHeaderFieldOptions_subscriptions): FieldValue;
    /** Gets the field for the specified sublist in the matrix. */
    getMatrixSublistField(options: GetMatrixSublistFieldOptions_addressbook | GetMatrixSublistFieldOptions_contactroles | GetMatrixSublistFieldOptions_creditcards | GetMatrixSublistFieldOptions_currency | GetMatrixSublistFieldOptions_download | GetMatrixSublistFieldOptions_grouppricing | GetMatrixSublistFieldOptions_itempricing | GetMatrixSublistFieldOptions_partners | GetMatrixSublistFieldOptions_salesteam | GetMatrixSublistFieldOptions_subscriptions): Field;
    /** Gets the value for the associated field in the matrix. */
    getMatrixSublistValue(options: GetMatrixSublistFieldOptions_addressbook | GetMatrixSublistFieldOptions_contactroles | GetMatrixSublistFieldOptions_creditcards | GetMatrixSublistFieldOptions_currency | GetMatrixSublistFieldOptions_download | GetMatrixSublistFieldOptions_grouppricing | GetMatrixSublistFieldOptions_itempricing | GetMatrixSublistFieldOptions_partners | GetMatrixSublistFieldOptions_salesteam | GetMatrixSublistFieldOptions_subscriptions): FieldValue;
    /** Sets the value for the line currently selected in the matrix. */
    setCurrentMatrixSublistValue(options: SetCurrentMatrixSublistValueOptions_addressbook | SetCurrentMatrixSublistValueOptions_contactroles | SetCurrentMatrixSublistValueOptions_creditcards | SetCurrentMatrixSublistValueOptions_currency | SetCurrentMatrixSublistValueOptions_download | SetCurrentMatrixSublistValueOptions_grouppricing | SetCurrentMatrixSublistValueOptions_itempricing | SetCurrentMatrixSublistValueOptions_partners | SetCurrentMatrixSublistValueOptions_salesteam | SetCurrentMatrixSublistValueOptions_subscriptions): Record;
    ...
    setCurrentSublistValue(options: SetCurrentSublistValueOptions_addressbook | SetCurrentSublistValueOptions_contactroles | SetCurrentSublistValueOptions_creditcards | SetCurrentSublistValueOptions_currency | SetCurrentSublistValueOptions_download | SetCurrentSublistValueOptions_grouppricing | SetCurrentSublistValueOptions_itempricing | SetCurrentSublistValueOptions_partners | SetCurrentSublistValueOptions_salesteam | SetCurrentSublistValueOptions_subscriptions): void;
    /** Sets the value of a sublist field. (standard mode only). */
    setSublistValue(options: SetSublistValueOptions_addressbook | SetSublistValueOptions_contactroles | SetSublistValueOptions_creditcards | SetSublistValueOptions_currency | SetSublistValueOptions_download | SetSublistValueOptions_grouppricing | SetSublistValueOptions_itempricing | SetSublistValueOptions_partners | SetSublistValueOptions_salesteam | SetSublistValueOptions_subscriptions): Record;
    /** Sets the value for the field in the currently selected line by a text representation. */
    setCurrentSublistText(options: SetCurrentSublistTextOptions_addressbook | SetCurrentSublistTextOptions_contactroles | SetCurrentSublistTextOptions_creditcards | SetCurrentSublistTextOptions_currency | SetCurrentSublistTextOptions_download | SetCurrentSublistTextOptions_grouppricing | SetCurrentSublistTextOptions_itempricing | SetCurrentSublistTextOptions_partners | SetCurrentSublistTextOptions_salesteam | SetCurrentSublistTextOptions_subscriptions): void;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_addressbook | SetSublistTextOptions_contactroles | SetSublistTextOptions_creditcards | SetSublistTextOptions_currency | SetSublistTextOptions_download | SetSublistTextOptions_grouppricing | SetSublistTextOptions_itempricing | SetSublistTextOptions_partners | SetSublistTextOptions_salesteam | SetSublistTextOptions_subscriptions): Record;
    /** Sets the value for the associated field in the matrix. */
    setMatrixSublistValue(options: SetSublistValueOptions_addressbook | SetSublistValueOptions_contactroles | SetSublistValueOptions_creditcards | SetSublistValueOptions_currency | SetSublistValueOptions_download | SetSublistValueOptions_grouppricing | SetSublistValueOptions_itempricing | SetSublistValueOptions_partners | SetSublistValueOptions_salesteam | SetSublistValueOptions_subscriptions): Record;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_addressbook | SetSublistTextOptions_contactroles | SetSublistTextOptions_creditcards | SetSublistTextOptions_currency | SetSublistTextOptions_download | SetSublistTextOptions_grouppricing | SetSublistTextOptions_itempricing | SetSublistTextOptions_partners | SetSublistTextOptions_salesteam | SetSublistTextOptions_subscriptions): Record;
    /** Returns the value of a sublist field. */
    getSublistValue(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): FieldValue;
    //getSublistValue(sublistId: string, fieldId: string, line: number): FieldValue;
    /** Returns a field object from a sublist. */
    getSublistField(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): Field;
    /** Returns the value of a sublist field in a text representation. */
    getSublistText(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): string;
    /** Returns a value indicating whether the associated sublist field contains a subrecord. */
    hasSublistSubrecord(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): boolean;
    /** Gets the subrecord associated with a sublist field. */
    getSublistSubrecord(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): Record;
    /** Removes the subrecord for the associated sublist field. */
    removeSublistSubrecord(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): Record;
    /** Returns the line number of the currently selected line. */
    getCurrentSublistIndex(options: GetSublistValueOptions_addressbook | GetSublistValueOptions_contactroles | GetSublistValueOptions_creditcards | GetSublistValueOptions_currency | GetSublistValueOptions_download | GetSublistValueOptions_grouppricing | GetSublistValueOptions_itempricing | GetSublistValueOptions_partners | GetSublistValueOptions_salesteam | GetSublistValueOptions_subscriptions): number;
