...
interface FindSublistLineWithValueOptions_item {
    ...
    fieldId: item_text | item_summary | item_float | item_posfloat;
...
export interface RecordCreateOptions_BIN_WORKSHEET { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BIN_WORKSHEET;
    /**
...
export interface RecordTransformOptions_BIN_WORKSHEET { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.BIN_WORKSHEET;
...
export interface CopyLoadOptions_BIN_WORKSHEET { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BIN_WORKSHEET;
...
export interface BIN_WORKSHEET extends Record {
