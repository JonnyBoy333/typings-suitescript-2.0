...
// taxregistration field types
type taxregistration_date = 'effectivefrom' | 'validuntil';
type taxregistration_select = 'nexus' | 'nexuscountry' | 'taxagency' | 'taxengine';
type taxregistration_text = 'taxregistrationnumber';
...
interface CancelCommitLineOptions {
    ...
    sublistId: 'accountingbookdetail' | 'taxregistration';
}
...
interface FindSublistLineWithValueOptions_accountingbookdetail {
    ...
    fieldId: accountingbookdetail_select;
...
// taxregistration type definitions
interface FindSublistLineWithValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface GetMatrixHeaderCountOptions_taxregistration {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'taxregistration';
    /** The intenral ID of the matrix field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface GetMatrixHeaderFieldOptions_taxregistration {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'taxregistration';
    /** The internal ID of the matrix field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface GetMatrixSublistFieldOptions_taxregistration {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'taxregistration';
    /** The intenral ID of the matrix field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface GetSublistValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface SetCurrentMatrixSublistValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface SetCurrentSublistValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface SetCurrentSublistTextOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface SetSublistTextOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
interface SetSublistValueOptions_taxregistration {
    /** The internal ID of the sublist. */
    sublistId: 'taxregistration';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: taxregistration_date | taxregistration_select | taxregistration_text;
...
export interface RecordCreateOptions_SUBSIDIARY { // This one gets exported
    /**
     * The record type.
     */
...
export interface RecordTransformOptions_SUBSIDIARY { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.SUBSIDIARY;
...
export interface CopyLoadOptions_SUBSIDIARY { // This one gets exported
    /**
     * The record type.
     */
    type: Type.SUBSIDIARY;
...
export interface SUBSIDIARY extends Record {
    ...
    getSublistField(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): Field;
    /** Returns the value of a sublist field in a text representation. */
    getSublistText(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): string;
    /** Returns a value indicating whether the associated sublist field contains a subrecord. */
    hasSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): boolean;
    /** Gets the subrecord associated with a sublist field. */
    getSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): Record;
    /** Removes the subrecord for the associated sublist field. */
    removeSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): Record;
    /** Returns the line number of the currently selected line. */
    getCurrentSublistIndex(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_taxregistration): number;
