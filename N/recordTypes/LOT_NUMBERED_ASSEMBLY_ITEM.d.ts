...
type main_textarea = 'description' | 'ebayitemdescription' | 'featureddescription' | 'matrixitemnametemplate' | 'metataghtml' | 'outofstockmessage' | 'pagetitle' | 'purchasedescription' | 'relateditemsdescription' | 'returnpolicydetails' | 'searchkeywords' | 'storedescription' | 'storedetaileddescription' | 'urlcomponent';
...
// itemvendor field types
type itemvendor_summary = 'itemvendorprice';
type itemvendor_checkbox = 'preferredvendor';
type itemvendor_rate = 'purchaseprice';
type itemvendor_select = 'schedule' | 'vendor';
type itemvendor_text = 'subsidiary' | 'vendorcode' | 'vendorcurrencyname';

// member field types
type member_date = 'effectivedate' | 'obsoletedate';
type member_select = 'effectiverevision' | 'item' | 'itemsource' | 'obsoleterevision' | 'taxschedule';
type member_textarea = 'memberdescr';
type member_text = 'memberunit' | 'weight';
type member_posfloat = 'quantity';
...
// quantitypricinglevel field types
type quantitypricinglevel_float = 'levelcount';
type quantitypricinglevel_percent = 'leveldiscount';
...
interface CancelCommitLineOptions {
    ...
    sublistId: 'accountingbookdetail' | 'binnumber' | 'itemvendor' | 'member' | 'price1' | 'price2' | 'price3' | 'price4' | 'quantitypricinglevel' | 'sitecategory';
}
...
// itemvendor type definitions
interface FindSublistLineWithValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface GetMatrixHeaderCountOptions_itemvendor {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'itemvendor';
    /** The intenral ID of the matrix field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface GetMatrixHeaderFieldOptions_itemvendor {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'itemvendor';
    /** The internal ID of the matrix field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface GetMatrixSublistFieldOptions_itemvendor {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'itemvendor';
    /** The intenral ID of the matrix field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface GetSublistValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface SetCurrentMatrixSublistValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface SetCurrentSublistValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface SetCurrentSublistTextOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface SetSublistTextOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface SetSublistValueOptions_itemvendor {
    /** The internal ID of the sublist. */
    sublistId: 'itemvendor';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: itemvendor_summary | itemvendor_checkbox | itemvendor_rate | itemvendor_select | itemvendor_text;
...
interface FindSublistLineWithValueOptions_member {
    ...
    sublistId: 'member';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: member_date | member_select | member_textarea | member_text | member_posfloat;
    /** The value to search for. */
    value: FieldValue;
}
...
// quantitypricinglevel type definitions
interface FindSublistLineWithValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
    /** The value to search for. */
    value: FieldValue;
}

interface GetCurrentSublistValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface GetMatrixHeaderCountOptions_quantitypricinglevel {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'quantitypricinglevel';
    /** The intenral ID of the matrix field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface GetMatrixHeaderFieldOptions_quantitypricinglevel {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of the matrix field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface GetMatrixSublistFieldOptions_quantitypricinglevel {
    /** The internal ID of the sublist that contains the matrix. */
    sublistId: 'quantitypricinglevel';
    /** The intenral ID of the matrix field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface GetSublistValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface SetCurrentMatrixSublistValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface SetCurrentSublistValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface SetCurrentSublistTextOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface SetSublistTextOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
interface SetSublistValueOptions_quantitypricinglevel {
    /** The internal ID of the sublist. */
    sublistId: 'quantitypricinglevel';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: quantitypricinglevel_float | quantitypricinglevel_percent;
...
export interface RecordCreateOptions_LOT_NUMBERED_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.LOT_NUMBERED_ASSEMBLY_ITEM;
    /**
...
export interface RecordTransformOptions_LOT_NUMBERED_ASSEMBLY_ITEM { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.LOT_NUMBERED_ASSEMBLY_ITEM;
...
export interface CopyLoadOptions_LOT_NUMBERED_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.LOT_NUMBERED_ASSEMBLY_ITEM;
...
export interface LOT_NUMBERED_ASSEMBLY_ITEM extends Record {

    /** Returns the line number of the first instance where a specified value is found in a specified column of the matrix. */
    findMatrixSublistLineWIthValue(options: FindSublistLineWithValueOptions_accountingbookdetail | FindSublistLineWithValueOptions_binnumber | FindSublistLineWithValueOptions_itemvendor | FindSublistLineWithValueOptions_member | FindSublistLineWithValueOptions_price1 | FindSublistLineWithValueOptions_price2 | FindSublistLineWithValueOptions_price3 | FindSublistLineWithValueOptions_price4 | FindSublistLineWithValueOptions_quantitypricinglevel | FindSublistLineWithValueOptions_sitecategory): number;
    /** Returns the line number for the first occurrence of a field value in a sublist. */
    findSublistLineWithValue(options: FindSublistLineWithValueOptions_accountingbookdetail | FindSublistLineWithValueOptions_binnumber | FindSublistLineWithValueOptions_itemvendor | FindSublistLineWithValueOptions_member | FindSublistLineWithValueOptions_price1 | FindSublistLineWithValueOptions_price2 | FindSublistLineWithValueOptions_price3 | FindSublistLineWithValueOptions_price4 | FindSublistLineWithValueOptions_quantitypricinglevel | FindSublistLineWithValueOptions_sitecategory): number;
    /** Gets the value for the currently selected line in the matrix. */
    getCurrentMatrixSublistValue(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_quantitypricinglevel | GetCurrentSublistValueOptions_sitecategory): number | Date | string | string[] | boolean;
    ...
    getMatrixHeaderCount(options: GetMatrixHeaderCountOptions_accountingbookdetail | GetMatrixHeaderCountOptions_binnumber | GetMatrixHeaderCountOptions_itemvendor | GetMatrixHeaderCountOptions_member | GetMatrixHeaderCountOptions_price1 | GetMatrixHeaderCountOptions_price2 | GetMatrixHeaderCountOptions_price3 | GetMatrixHeaderCountOptions_price4 | GetMatrixHeaderCountOptions_quantitypricinglevel | GetMatrixHeaderCountOptions_sitecategory): number;
    /** Gets the field for the specified header in the matrix. */
    getMatrixHeaderField(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_binnumber | GetMatrixHeaderFieldOptions_itemvendor | GetMatrixHeaderFieldOptions_member | GetMatrixHeaderFieldOptions_price1 | GetMatrixHeaderFieldOptions_price2 | GetMatrixHeaderFieldOptions_price3 | GetMatrixHeaderFieldOptions_price4 | GetMatrixHeaderFieldOptions_quantitypricinglevel | GetMatrixHeaderFieldOptions_sitecategory): Field;
    /** Gets the value for the associated header in the matrix. */
    getMatrixHeaderValue(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_binnumber | GetMatrixHeaderFieldOptions_itemvendor | GetMatrixHeaderFieldOptions_member | GetMatrixHeaderFieldOptions_price1 | GetMatrixHeaderFieldOptions_price2 | GetMatrixHeaderFieldOptions_price3 | GetMatrixHeaderFieldOptions_price4 | GetMatrixHeaderFieldOptions_quantitypricinglevel | GetMatrixHeaderFieldOptions_sitecategory): FieldValue;
    /** Gets the field for the specified sublist in the matrix. */
    getMatrixSublistField(options: GetMatrixSublistFieldOptions_accountingbookdetail | GetMatrixSublistFieldOptions_binnumber | GetMatrixSublistFieldOptions_itemvendor | GetMatrixSublistFieldOptions_member | GetMatrixSublistFieldOptions_price1 | GetMatrixSublistFieldOptions_price2 | GetMatrixSublistFieldOptions_price3 | GetMatrixSublistFieldOptions_price4 | GetMatrixSublistFieldOptions_quantitypricinglevel | GetMatrixSublistFieldOptions_sitecategory): Field;
    /** Gets the value for the associated field in the matrix. */
    getMatrixSublistValue(options: GetMatrixSublistFieldOptions_accountingbookdetail | GetMatrixSublistFieldOptions_binnumber | GetMatrixSublistFieldOptions_itemvendor | GetMatrixSublistFieldOptions_member | GetMatrixSublistFieldOptions_price1 | GetMatrixSublistFieldOptions_price2 | GetMatrixSublistFieldOptions_price3 | GetMatrixSublistFieldOptions_price4 | GetMatrixSublistFieldOptions_quantitypricinglevel | GetMatrixSublistFieldOptions_sitecategory): FieldValue;
    /** Sets the value for the line currently selected in the matrix. */
    setCurrentMatrixSublistValue(options: SetCurrentMatrixSublistValueOptions_accountingbookdetail | SetCurrentMatrixSublistValueOptions_binnumber | SetCurrentMatrixSublistValueOptions_itemvendor | SetCurrentMatrixSublistValueOptions_member | SetCurrentMatrixSublistValueOptions_price1 | SetCurrentMatrixSublistValueOptions_price2 | SetCurrentMatrixSublistValueOptions_price3 | SetCurrentMatrixSublistValueOptions_price4 | SetCurrentMatrixSublistValueOptions_quantitypricinglevel | SetCurrentMatrixSublistValueOptions_sitecategory): Record;
    /** Sets the value for the associated header in the matrix. */
    setMatrixHeaderValue(options: SetCurrentMatrixSublistValueOptions_accountingbookdetail | SetCurrentMatrixSublistValueOptions_binnumber | SetCurrentMatrixSublistValueOptions_itemvendor | SetCurrentMatrixSublistValueOptions_member | SetCurrentMatrixSublistValueOptions_price1 | SetCurrentMatrixSublistValueOptions_price2 | SetCurrentMatrixSublistValueOptions_price3 | SetCurrentMatrixSublistValueOptions_price4 | SetCurrentMatrixSublistValueOptions_quantitypricinglevel | SetCurrentMatrixSublistValueOptions_sitecategory): Record;
    /** Sets the value for the field in the currently selected line. */
    setCurrentSublistValue(options: SetCurrentSublistValueOptions_accountingbookdetail | SetCurrentSublistValueOptions_binnumber | SetCurrentSublistValueOptions_itemvendor | SetCurrentSublistValueOptions_member | SetCurrentSublistValueOptions_price1 | SetCurrentSublistValueOptions_price2 | SetCurrentSublistValueOptions_price3 | SetCurrentSublistValueOptions_price4 | SetCurrentSublistValueOptions_quantitypricinglevel | SetCurrentSublistValueOptions_sitecategory): void;
    /** Sets the value of a sublist field. (standard mode only). */
    setSublistValue(options: SetSublistValueOptions_accountingbookdetail | SetSublistValueOptions_binnumber | SetSublistValueOptions_itemvendor | SetSublistValueOptions_member | SetSublistValueOptions_price1 | SetSublistValueOptions_price2 | SetSublistValueOptions_price3 | SetSublistValueOptions_price4 | SetSublistValueOptions_quantitypricinglevel | SetSublistValueOptions_sitecategory): Record;
    /** Sets the value for the field in the currently selected line by a text representation. */
    setCurrentSublistText(options: SetCurrentSublistTextOptions_accountingbookdetail | SetCurrentSublistTextOptions_binnumber | SetCurrentSublistTextOptions_itemvendor | SetCurrentSublistTextOptions_member | SetCurrentSublistTextOptions_price1 | SetCurrentSublistTextOptions_price2 | SetCurrentSublistTextOptions_price3 | SetCurrentSublistTextOptions_price4 | SetCurrentSublistTextOptions_quantitypricinglevel | SetCurrentSublistTextOptions_sitecategory): void;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_accountingbookdetail | SetSublistTextOptions_binnumber | SetSublistTextOptions_itemvendor | SetSublistTextOptions_member | SetSublistTextOptions_price1 | SetSublistTextOptions_price2 | SetSublistTextOptions_price3 | SetSublistTextOptions_price4 | SetSublistTextOptions_quantitypricinglevel | SetSublistTextOptions_sitecategory): Record;
    /** Sets the value for the associated field in the matrix. */
    setMatrixSublistValue(options: SetSublistValueOptions_accountingbookdetail | SetSublistValueOptions_binnumber | SetSublistValueOptions_itemvendor | SetSublistValueOptions_member | SetSublistValueOptions_price1 | SetSublistValueOptions_price2 | SetSublistValueOptions_price3 | SetSublistValueOptions_price4 | SetSublistValueOptions_quantitypricinglevel | SetSublistValueOptions_sitecategory): Record;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_accountingbookdetail | SetSublistTextOptions_binnumber | SetSublistTextOptions_itemvendor | SetSublistTextOptions_member | SetSublistTextOptions_price1 | SetSublistTextOptions_price2 | SetSublistTextOptions_price3 | SetSublistTextOptions_price4 | SetSublistTextOptions_quantitypricinglevel | SetSublistTextOptions_sitecategory): Record;
    /** Returns the value of a sublist field. */
    getSublistValue(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): FieldValue;
    //getSublistValue(sublistId: string, fieldId: string, line: number): FieldValue;
    /** Returns a field object from a sublist. */
    getSublistField(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): Field;
    /** Returns the value of a sublist field in a text representation. */
    getSublistText(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): string;
    /** Returns a value indicating whether the associated sublist field contains a subrecord. */
    hasSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): boolean;
    /** Gets the subrecord associated with a sublist field. */
    getSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): Record;
    /** Removes the subrecord for the associated sublist field. */
    removeSublistSubrecord(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): Record;
    /** Returns the line number of the currently selected line. */
    getCurrentSublistIndex(options: GetSublistValueOptions_accountingbookdetail | GetSublistValueOptions_binnumber | GetSublistValueOptions_itemvendor | GetSublistValueOptions_member | GetSublistValueOptions_price1 | GetSublistValueOptions_price2 | GetSublistValueOptions_price3 | GetSublistValueOptions_price4 | GetSublistValueOptions_quantitypricinglevel | GetSublistValueOptions_sitecategory): number;
