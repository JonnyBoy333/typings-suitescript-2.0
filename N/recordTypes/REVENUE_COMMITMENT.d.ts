...
// main field types
type main_select = 'accountingbook' | 'billaddresslist' | 'class' | 'couponcode' | 'createdfrom' | 'currency' | 'customform' | 'department' | 'discountitem' | 'entity' | 'entitynexus' | 'job' | 'location' | 'nexus' | 'opportunity' | 'partner' | 'postingperiod' | 'promocode' | 'salesgroup' | 'salesrep' | 'shipaddresslist' | 'subsidiary';
...
type main_date = 'discountdate' | 'enddate' | 'startdate' | 'trandate';
...
export interface RecordCreateOptions_REVENUE_COMMITMENT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.REVENUE_COMMITMENT;
    /**
...
export interface RecordTransformOptions_REVENUE_COMMITMENT { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.REVENUE_COMMITMENT;
...
export interface CopyLoadOptions_REVENUE_COMMITMENT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.REVENUE_COMMITMENT;
...
export interface REVENUE_COMMITMENT extends Record {
