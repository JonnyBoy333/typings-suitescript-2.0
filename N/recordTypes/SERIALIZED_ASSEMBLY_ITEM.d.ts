...
interface CancelCommitLineOptions {
    ...
    sublistId: 'accountingbookdetail' | 'binnumber' | 'itemvendor' | 'member' | 'price1' | 'price2' | 'price3' | 'price4' | 'sitecategory';
}
...
export interface RecordCreateOptions_SERIALIZED_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.SERIALIZED_ASSEMBLY_ITEM;
    /**
...
export interface RecordTransformOptions_SERIALIZED_ASSEMBLY_ITEM { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.SERIALIZED_ASSEMBLY_ITEM;
...
export interface CopyLoadOptions_SERIALIZED_ASSEMBLY_ITEM { // This one gets exported
    /**
     * The record type.
     */
    type: Type.SERIALIZED_ASSEMBLY_ITEM;
...
export interface SERIALIZED_ASSEMBLY_ITEM extends Record {
    ...
    getCurrentMatrixSublistValue(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_sitecategory): number | Date | string | string[] | boolean;
    /** Returns a value indicating whether the associated sublist field has a subrecord on the current line. This method can only be used on dynamic records. */
    hasCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_sitecategory): boolean;
    /** Gets the subrecord for the associated sublist field on the current line. */
    getCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_sitecategory): Record;
    /** Returns a text representation of the field value in the currently selected line. */
    getCurrentSublistText(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_sitecategory): string;
    /** Returns the value of a sublist field on the currently selected sublist line. */
    getCurrentSublistValue(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_binnumber | GetCurrentSublistValueOptions_itemvendor | GetCurrentSublistValueOptions_member | GetCurrentSublistValueOptions_price1 | GetCurrentSublistValueOptions_price2 | GetCurrentSublistValueOptions_price3 | GetCurrentSublistValueOptions_price4 | GetCurrentSublistValueOptions_sitecategory): FieldValue;
    ...
    getMatrixHeaderField(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_binnumber | GetMatrixHeaderFieldOptions_itemvendor | GetMatrixHeaderFieldOptions_member | GetMatrixHeaderFieldOptions_price1 | GetMatrixHeaderFieldOptions_price2 | GetMatrixHeaderFieldOptions_price3 | GetMatrixHeaderFieldOptions_price4 | GetMatrixHeaderFieldOptions_sitecategory): Field;
    /** Gets the value for the associated header in the matrix. */
    getMatrixHeaderValue(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_binnumber | GetMatrixHeaderFieldOptions_itemvendor | GetMatrixHeaderFieldOptions_member | GetMatrixHeaderFieldOptions_price1 | GetMatrixHeaderFieldOptions_price2 | GetMatrixHeaderFieldOptions_price3 | GetMatrixHeaderFieldOptions_price4 | GetMatrixHeaderFieldOptions_sitecategory): FieldValue;
    ...
    setCurrentMatrixSublistValue(options: SetCurrentMatrixSublistValueOptions_accountingbookdetail | SetCurrentMatrixSublistValueOptions_binnumber | SetCurrentMatrixSublistValueOptions_itemvendor | SetCurrentMatrixSublistValueOptions_member | SetCurrentMatrixSublistValueOptions_price1 | SetCurrentMatrixSublistValueOptions_price2 | SetCurrentMatrixSublistValueOptions_price3 | SetCurrentMatrixSublistValueOptions_price4 | SetCurrentMatrixSublistValueOptions_sitecategory): Record;
