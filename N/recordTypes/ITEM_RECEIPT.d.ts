...
// main field types
type main_select = 'class' | 'createdfrom' | 'currency' | 'customform' | 'department' | 'entity' | 'itemfulfillment' | 'location' | 'postingperiod' | 'subsidiary';
type main_datetime = 'createddate' | 'lastmodifieddate';
type main_text = 'currencyname' | 'currencysymbol' | 'externalid' | 'memo' | 'tranid';
type main_currency2 = 'exchangerate';
type main_checkbox = 'isbasecurrency' | 'landedcostperline';
...
type expense_checkbox = 'markreceived';

// item field types
type item_text = 'class' | 'countryofmanufacture' | 'department' | 'item' | 'itemdescription' | 'itemkey' | 'itemname' | 'itemtype' | 'line' | 'manufactureraddr1' | 'manufacturercity' | 'manufacturerstate' | 'manufacturertariff' | 'manufacturertaxid' | 'manufacturerzip' | 'multmanufactureaddr' | 'preferencecriterion' | 'producer' | 'schedulebcode' | 'schedulebnumber' | 'schedulebquantity' | 'sitemname' | 'units';
type item_summary = 'inventorydetail';
type item_checkbox = 'itemreceive' | 'restock';
type item_select = 'location';
type item_float = 'onhand' | 'quantityremaining';
type item_namevaluelist = 'options';
type item_posfloat = 'quantity';
...
interface FindSublistLineWithValueOptions_expense {
    ...
    sublistId: 'expense';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: expense_currency | expense_checkbox;
    /** The value to search for. */
    value: FieldValue;
}
...
interface FindSublistLineWithValueOptions_item {
    ...
    sublistId: 'item';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: item_text | item_summary | item_checkbox | item_select | item_float | item_namevaluelist | item_posfloat;
    /** The value to search for. */
    value: FieldValue;
}
...
interface HasSubrecordOptions {
    ...
    fieldId: main_select | main_datetime | main_text | main_currency2 | main_checkbox | main_date;
}
...
export interface RecordCreateOptions_ITEM_RECEIPT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ITEM_RECEIPT;
    /**
...
export interface RecordTransformOptions_ITEM_RECEIPT { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.ITEM_RECEIPT;
...
export interface CopyLoadOptions_ITEM_RECEIPT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.ITEM_RECEIPT;
...
export interface ITEM_RECEIPT extends Record {
