...
type expense_text = 'category' | 'line' | 'memo';
type expense_checkbox = 'isbillable';

// item field types
type item_currency = 'amount';
type item_text = 'billvariancestatus' | 'id' | 'isvsoebundle' | 'itemsubtype' | 'itemtype' | 'line' | 'matrixtype' | 'rateschedule' | 'vendorname';
type item_select = 'catchupperiod' | 'class' | 'customer' | 'department' | 'item' | 'location' | 'taxcode' | 'units';
...
interface FindSublistLineWithValueOptions_expense {
    ...
    sublistId: 'expense';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: expense_select | expense_currency | expense_text | expense_checkbox;
    /** The value to search for. */
    value: FieldValue;
}
...
interface FindSublistLineWithValueOptions_item {
    ...
    sublistId: 'item';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: item_currency | item_text | item_select | item_checkbox | item_textarea | item_summary | item_integer | item_namevaluelist | item_float | item_rate | item_percent;
    /** The value to search for. */
    value: FieldValue;
}
...
export interface RecordCreateOptions_CHECK { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CHECK;
...
export interface RecordTransformOptions_CHECK { // This one gets exported
...
export interface CopyLoadOptions_CHECK { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CHECK;
