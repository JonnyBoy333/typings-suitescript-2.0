...
export interface PURCHASE_CONTRACT extends Record {
    ...
    findMatrixSublistLineWIthValue(options: FindSublistLineWithValueOptions_accountingbookdetail | FindSublistLineWithValueOptions_discount | FindSublistLineWithValueOptions_item | FindSublistLineWithValueOptions_links): number;
    /** Returns the line number for the first occurrence of a field value in a sublist. */
    findSublistLineWithValue(options: FindSublistLineWithValueOptions_accountingbookdetail | FindSublistLineWithValueOptions_discount | FindSublistLineWithValueOptions_item | FindSublistLineWithValueOptions_links): number;
    /** Gets the value for the currently selected line in the matrix. */
    getCurrentMatrixSublistValue(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_discount | GetCurrentSublistValueOptions_item | GetCurrentSublistValueOptions_links): number | Date | string | string[] | boolean;
    /** Returns a value indicating whether the associated sublist field has a subrecord on the current line. This method can only be used on dynamic records. */
    hasCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_discount | GetCurrentSublistValueOptions_item | GetCurrentSublistValueOptions_links): boolean;
    /** Gets the subrecord for the associated sublist field on the current line. */
    getCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_discount | GetCurrentSublistValueOptions_item | GetCurrentSublistValueOptions_links): Record;
    /** Returns a text representation of the field value in the currently selected line. */
    getCurrentSublistText(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_discount | GetCurrentSublistValueOptions_item | GetCurrentSublistValueOptions_links): string;
    /** Returns the value of a sublist field on the currently selected sublist line. */
    getCurrentSublistValue(options: GetCurrentSublistValueOptions_accountingbookdetail | GetCurrentSublistValueOptions_discount | GetCurrentSublistValueOptions_item | GetCurrentSublistValueOptions_links): FieldValue;
    /** Returns the number of columns for the specified matrix. */
    getMatrixHeaderCount(options: GetMatrixHeaderCountOptions_accountingbookdetail | GetMatrixHeaderCountOptions_discount | GetMatrixHeaderCountOptions_item | GetMatrixHeaderCountOptions_links): number;
    /** Gets the field for the specified header in the matrix. */
    getMatrixHeaderField(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_discount | GetMatrixHeaderFieldOptions_item | GetMatrixHeaderFieldOptions_links): Field;
    /** Gets the value for the associated header in the matrix. */
    getMatrixHeaderValue(options: GetMatrixHeaderFieldOptions_accountingbookdetail | GetMatrixHeaderFieldOptions_discount | GetMatrixHeaderFieldOptions_item | GetMatrixHeaderFieldOptions_links): FieldValue;
    /** Gets the field for the specified sublist in the matrix. */
    getMatrixSublistField(options: GetMatrixSublistFieldOptions_accountingbookdetail | GetMatrixSublistFieldOptions_discount | GetMatrixSublistFieldOptions_item | GetMatrixSublistFieldOptions_links): Field;
    /** Gets the value for the associated field in the matrix. */
    getMatrixSublistValue(options: GetMatrixSublistFieldOptions_accountingbookdetail | GetMatrixSublistFieldOptions_discount | GetMatrixSublistFieldOptions_item | GetMatrixSublistFieldOptions_links): FieldValue;
    /** Sets the value for the line currently selected in the matrix. */
    setCurrentMatrixSublistValue(options: SetCurrentMatrixSublistValueOptions_accountingbookdetail | SetCurrentMatrixSublistValueOptions_discount | SetCurrentMatrixSublistValueOptions_item | SetCurrentMatrixSublistValueOptions_links): Record;
    /** Sets the value for the associated header in the matrix. */
    setMatrixHeaderValue(options: SetCurrentMatrixSublistValueOptions_accountingbookdetail | SetCurrentMatrixSublistValueOptions_discount | SetCurrentMatrixSublistValueOptions_item | SetCurrentMatrixSublistValueOptions_links): Record;
    /** Sets the value for the field in the currently selected line. */
    setCurrentSublistValue(options: SetCurrentSublistValueOptions_accountingbookdetail | SetCurrentSublistValueOptions_discount | SetCurrentSublistValueOptions_item | SetCurrentSublistValueOptions_links): void;
    /** Sets the value of a sublist field. (standard mode only). */
    setSublistValue(options: SetSublistValueOptions_accountingbookdetail | SetSublistValueOptions_discount | SetSublistValueOptions_item | SetSublistValueOptions_links): Record;
    /** Sets the value for the field in the currently selected line by a text representation. */
    setCurrentSublistText(options: SetCurrentSublistTextOptions_accountingbookdetail | SetCurrentSublistTextOptions_discount | SetCurrentSublistTextOptions_item | SetCurrentSublistTextOptions_links): void;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_accountingbookdetail | SetSublistTextOptions_discount | SetSublistTextOptions_item | SetSublistTextOptions_links): Record;
    /** Sets the value for the associated field in the matrix. */
    setMatrixSublistValue(options: SetSublistValueOptions_accountingbookdetail | SetSublistValueOptions_discount | SetSublistValueOptions_item | SetSublistValueOptions_links): Record;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_accountingbookdetail | SetSublistTextOptions_discount | SetSublistTextOptions_item | SetSublistTextOptions_links): Record;
