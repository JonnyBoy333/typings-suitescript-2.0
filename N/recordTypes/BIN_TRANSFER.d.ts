...
type inventory_text = 'description' | 'itemunitslabel' | 'line' | 'preferredbin';
type inventory_summary = 'inventorydetail';
type inventory_select = 'item';
type inventory_float = 'quantity';
...
interface FindSublistLineWithValueOptions_inventory {
    ...
    fieldId: inventory_text | inventory_summary | inventory_select | inventory_float;
...
interface HasSubrecordOptions {
    ...
    fieldId: main_datetime | main_text | main_select | main_currency | main_date;
}
...
export interface RecordCreateOptions_BIN_TRANSFER { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BIN_TRANSFER;
    /**
...
export interface RecordTransformOptions_BIN_TRANSFER { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.BIN_TRANSFER;
...
export interface CopyLoadOptions_BIN_TRANSFER { // This one gets exported
    /**
     * The record type.
     */
    type: Type.BIN_TRANSFER;
...
export interface BIN_TRANSFER extends Record {
