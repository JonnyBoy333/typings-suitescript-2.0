...
export interface RecordCreateOptions_CONTACT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CONTACT;
...
export interface RecordTransformOptions_CONTACT { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.CONTACT;
...
export interface CopyLoadOptions_CONTACT { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CONTACT;
