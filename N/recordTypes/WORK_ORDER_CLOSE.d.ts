...
export interface WORK_ORDER_CLOSE extends Record {
    ...
    findMatrixSublistLineWIthValue(options: FindSublistLineWithValueOptions_component | FindSublistLineWithValueOptions_routingitem): number;
    /** Returns the line number for the first occurrence of a field value in a sublist. */
    findSublistLineWithValue(options: FindSublistLineWithValueOptions_component | FindSublistLineWithValueOptions_routingitem): number;
    /** Gets the value for the currently selected line in the matrix. */
    getCurrentMatrixSublistValue(options: GetCurrentSublistValueOptions_component | GetCurrentSublistValueOptions_routingitem): number | Date | string | string[] | boolean;
    /** Returns a value indicating whether the associated sublist field has a subrecord on the current line. This method can only be used on dynamic records. */
    hasCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_component | GetCurrentSublistValueOptions_routingitem): boolean;
    /** Gets the subrecord for the associated sublist field on the current line. */
    getCurrentSublistSubrecord(options: GetCurrentSublistValueOptions_component | GetCurrentSublistValueOptions_routingitem): Record;
    /** Returns a text representation of the field value in the currently selected line. */
    getCurrentSublistText(options: GetCurrentSublistValueOptions_component | GetCurrentSublistValueOptions_routingitem): string;
    /** Returns the value of a sublist field on the currently selected sublist line. */
    getCurrentSublistValue(options: GetCurrentSublistValueOptions_component | GetCurrentSublistValueOptions_routingitem): FieldValue;
    /** Returns the number of columns for the specified matrix. */
    getMatrixHeaderCount(options: GetMatrixHeaderCountOptions_component | GetMatrixHeaderCountOptions_routingitem): number;
    /** Gets the field for the specified header in the matrix. */
    getMatrixHeaderField(options: GetMatrixHeaderFieldOptions_component | GetMatrixHeaderFieldOptions_routingitem): Field;
    /** Gets the value for the associated header in the matrix. */
    getMatrixHeaderValue(options: GetMatrixHeaderFieldOptions_component | GetMatrixHeaderFieldOptions_routingitem): FieldValue;
    /** Gets the field for the specified sublist in the matrix. */
    getMatrixSublistField(options: GetMatrixSublistFieldOptions_component | GetMatrixSublistFieldOptions_routingitem): Field;
    /** Gets the value for the associated field in the matrix. */
    getMatrixSublistValue(options: GetMatrixSublistFieldOptions_component | GetMatrixSublistFieldOptions_routingitem): FieldValue;
    /** Sets the value for the line currently selected in the matrix. */
    setCurrentMatrixSublistValue(options: SetCurrentMatrixSublistValueOptions_component | SetCurrentMatrixSublistValueOptions_routingitem): Record;
    /** Sets the value for the associated header in the matrix. */
    setMatrixHeaderValue(options: SetCurrentMatrixSublistValueOptions_component | SetCurrentMatrixSublistValueOptions_routingitem): Record;
    /** Sets the value for the field in the currently selected line. */
    setCurrentSublistValue(options: SetCurrentSublistValueOptions_component | SetCurrentSublistValueOptions_routingitem): void;
    /** Sets the value of a sublist field. (standard mode only). */
    setSublistValue(options: SetSublistValueOptions_component | SetSublistValueOptions_routingitem): Record;
    /** Sets the value for the field in the currently selected line by a text representation. */
    setCurrentSublistText(options: SetCurrentSublistTextOptions_component | SetCurrentSublistTextOptions_routingitem): void;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_component | SetSublistTextOptions_routingitem): Record;
    /** Sets the value for the associated field in the matrix. */
    setMatrixSublistValue(options: SetSublistValueOptions_component | SetSublistValueOptions_routingitem): Record;
    /** Sets the value of a sublist field by a text representation. */
    setSublistText(options: SetSublistTextOptions_component | SetSublistTextOptions_routingitem): Record;
