...
export interface RecordCreateOptions_USAGE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.USAGE;
...
export interface RecordTransformOptions_USAGE { // This one gets exported
...
export interface CopyLoadOptions_USAGE { // This one gets exported
    /**
     * The record type.
     */
    type: Type.USAGE;
