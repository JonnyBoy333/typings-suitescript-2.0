...
// main field types
type main_select = 'class' | 'currency' | 'customform' | 'department' | 'location' | 'postingperiod' | 'subsidiary' | 'transtatus';
type main_datetime = 'createddate' | 'lastmodifieddate';
type main_currency = 'credittotal' | 'debittotal' | 'total';
type main_currency2 = 'exchangerate';
type main_text = 'externalid' | 'status' | 'statusRef' | 'taxperiod' | 'tranid';
...
// line field types
type line_select = 'account' | 'class' | 'department' | 'entity' | 'location';
type line_poscurrency = 'amount';
type line_currency = 'credit' | 'debit';
...
interface FindSublistLineWithValueOptions_line {
    ...
    sublistId: 'line';
    /** The internal ID of a standard or custom sublist field. */
    fieldId: line_select | line_poscurrency | line_currency | line_integer | line_text;
    /** The value to search for. */
    value: FieldValue;
}
...
interface HasSubrecordOptions {
    ...
    fieldId: main_select | main_datetime | main_currency | main_currency2 | main_text | main_checkbox | main_textarea | main_date;
}
...
export interface RecordCreateOptions_CUSTOM_TRANSACTION { // This one gets exported
    /**
     * The record type.
     */
...
export interface RecordTransformOptions_CUSTOM_TRANSACTION { // This one gets exported
    /** The record type of the existing record instance being transformed. */
    fromType: Type.CUSTOM_TRANSACTION;
...
export interface CopyLoadOptions_CUSTOM_TRANSACTION { // This one gets exported
    /**
     * The record type.
     */
    type: Type.CUSTOM_TRANSACTION;
...
export interface CUSTOM_TRANSACTION extends Record {
